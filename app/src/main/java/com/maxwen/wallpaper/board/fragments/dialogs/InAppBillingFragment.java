...
import com.maxwen.wallpaper.board.adapters.InAppBillingAdapter;
...
public class InAppBillingFragment extends DialogFragment {
    ...
    private static final String TAG = "com.maxwen.wallpaper.board.dialog.inappbilling";
