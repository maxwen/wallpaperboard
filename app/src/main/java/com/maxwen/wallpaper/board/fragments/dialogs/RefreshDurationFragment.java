...
import com.maxwen.wallpaper.board.utils.listeners.RefreshDurationListener;
...
public class RefreshDurationFragment extends DialogFragment implements View.OnClickListener {
    ...
    private static final String TAG = "com.maxwen.wallpaper.board.dialog.refresh.duration";
