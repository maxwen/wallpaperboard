...
import com.maxwen.wallpaper.board.helpers.CrashReportHelper;
...
public class WallpaperBoardCrashReport extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            final String stackTrace = bundle.getString(EXTRA_STACKTRACE);
            final String deviceInfo = CrashReportHelper.getDeviceInfoForCrashReport(this);
